    ...
    <div className={`d-flex justify-content-center my-3 text-${isdarkMode?'white':'black'}`} style={{ width: '100%' }}>
      <div style={{ maxWidth: '800px' }}>
        <>
          ...
          <p>
            This page explains the disclaimer for using CrunchCave services present in
            the URL CrunchCave.com.Read the below points before taking any actions
          ...
          <p>2. Consent&nbsp;</p>
          <p>3. Update&nbsp;</p>
          <h2 style={{ textAlign: "left" }}>Disclaimers for CrunchCave&nbsp;</h2>
          <p>
            All the information on this website - CrunchCave.com- is published in good
            faith and for general information purposes only. CrunchCave does not make any
            ...
            website --CrunchCave--, is strictly at your own risk. CrunchCave will not be
