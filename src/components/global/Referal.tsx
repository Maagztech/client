...
const Referal = () => {
    ...
    if (auth.access_token) {
      navigator.clipboard
        .writeText(`Hi, I just invited you to use the Pediageek ! 
            ...
            Link. ${window.location.origin.toString()}/register?ref=${
        auth.user?._id
      }`);
  ...
  return (
    <div
      ...
      id="referalmodal"
      tabIndex={-1}
      aria-labelledby="referalLabel"
      aria-hidden="true"
    >
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title" id="referalLabel">
              Referal Box
            </h5>
            <button
              type="button"
          ...
          <div className="modal-body row ">
            ...
            <div className="col-6 text-center">
              ...
              <br />
              <small>copy code tell your friend to enter at Sign-up.</small>
            </div>
          </div>
        </div>
      </div>
